...
Aqui você vai encontrar os detalhes de como estruturar o desenvolvimento do seu projeto.
...
- Todas as funções já estão declaradas nos arquivos `challenges.js` e `challenges2.js`. Você pode criar outras funções para auxiliar as já existentes. 
